        ...
        <div class="col-md-3 mb-3">
            <div class="card stats-card">
                <div class="card-body">
                    ...
                    <div class="number"><?= $total_colaboradores; ?></div>
        ...
        <div class="col-md-3 mb-3">
            <div class="card stats-card">
                <div class="card-body">
                    ...
                    <div class="number"><?php echo $pontos_hoje; ?></div>
        ...
        <div class="col-md-3 mb-3">
            <div class="card stats-card">
                <div class="card-body">
                    ...
                    <div class="number"><?php echo $ativos_hoje; ?></div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php foreach ($ultimos_registros as $registro): ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($registro['colaborador_nome']); ?></td>
                                        <td><span
                                                class="badge bg-primary"><?php echo $registro['colaborador_codigo']; ?></span>
                                        </td>
                                        <td>
                                            <span
                                                class="badge 
                                        ...
                                        <td><?php echo $registro['hora_registro']; ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                    ...
                    <ul class="list-group list-group-flush">
                        <?php foreach ($por_turno as $turno): ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                ?>
                                <span class="badge bg-primary rounded-pill"><?php echo $turno['total']; ?></span>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            ...
            <!-- <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="registrar_ponto.php" class="btn btn-primary">
                            <i class="fas fa-fingerprint"></i> Registrar Ponto
                        </a>
                        <a href="colaboradores.php?action=add" class="btn btn-success">
                            <i class="fas fa-user-plus"></i> Novo Colaborador
                        </a>
                        <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#facialModal">
