...
$stmt = $pdo->query("SELECT * FROM empresas WHERE ativa = 1 ORDER BY nome ASC");
$stmt->execute();
        ...
        <tbody>
            <?php foreach ($empresas as $empresa): ?>
                <tr>
                    ...
                    <td><span class="badge bg-warning"><?php echo $empresa['prefixo']; ?></span></td>
                    ...
                    <td>
                        <button type="button" class="btn btn-sm btn-warning btneditEmpresaModal"                              
                            data-id=<?= $empresa['id'] ?>
                        ...
                        <button type="button" class="btn btn-sm btn-danger btndeleteEmpresaModals"
                            data-id=<?= $empresa['id'] ?> data-nome=<?= $empresa['nome'] ?> data-cnpj=<?= $empresa['cnpj'] ?>
                            data-prefixo=<?= $empresa['prefixo'] ?> data-endereco=<?= $empresa['endereco'] ?>
                            data-email=<?= $empresa['email'] ?>>
