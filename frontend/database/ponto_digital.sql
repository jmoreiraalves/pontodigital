...
/*Table structure for table `atestados_medicos` */

DROP TABLE IF EXISTS `atestados_medicos`;

CREATE TABLE `atestados_medicos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `colaborador_id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
  `cid` varchar(10) DEFAULT NULL COMMENT 'Código CID',
  `diagnostico` text DEFAULT NULL,
  `data_emissao` date NOT NULL,
  `data_inicio` date NOT NULL,
  `data_fim` date NOT NULL,
  `dias_afastamento` int(11) NOT NULL,
  `horas_afastamento` int(11) DEFAULT 0,
  ...
  CONSTRAINT `atestados_medicos_ibfk_1` FOREIGN KEY (`colaborador_id`) REFERENCES `colaboradores` (`id`) ON DELETE CASCADE,
  CONSTRAINT `atestados_medicos_ibfk_2` FOREIGN KEY (`empresa_id`) REFERENCES `empresas` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `atestados_medicos` */
...
(1,'Principal','00000000000100','EMP','RUA SETE, 80\r\nJARDIM MONTE VERDE','(35)98406-4272','contato@empresa.com',1,'2025-12-23 14:12:01','2026-01-03 18:26:46'),
(2,'Testando Empresa ltda','11.000.000/0001-11','EMT','Rua vinte e um, 99 - jardim monte azul',NULL,'contato@teste.com.br',1,'2025-12-31 11:03:55','2026-01-03 17:13:23'),
...
(4,'j2system ltda','46046644000111','j2s','RUA SETE, 80\r\nJARDIM MONTE VERDE','35984064272','contato@j2syswtem.com',1,'2026-01-03 18:28:06','2026-01-03 18:28:06');
...
CREATE TABLE `registros_ponto` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `atestado_id` int(11) DEFAULT NULL,
  `abonado_atestado` tinyint(1) DEFAULT 0 COMMENT 'Indica se o dia foi abonado por atestado',
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `registros_ponto_ibfk_3` FOREIGN KEY (`atestado_id`) REFERENCES `atestados_medicos` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1,1,'EMP001','João Carlos Moreira Alves Junior','000.000.000-00','admin@admin.com','$2y$10$G6ECLI7oJgbBmTrRZzJZreWz2vrI2OZ9QAi6.PQd03NXPGLUJWGOe','super',1,NULL,'2025-12-23 14:12:01','2026-01-03 15:54:20');
